...
public class App {
	...
	public static void main(String[] args) {
		...
		while (cambios) {
			...
			String[][] nuevaMatriz = new String[filas][columnas];//si hay cambios, se hace añade a la nueva matriz//la matriz que se reinicia todo el rato, con la que se compara, que siempre va a ser la generacion anterior
		...
		System.out.println("No hay más cambios, la simulación ha terminado.");
		entrada.close();
	}
}
